...
class PersonDetail {
    ...
    init(name:String,age:Int,bdate:String) {
        self.name = name
        self.age = age
        self.bdate = bdate
    }
    subscript(Name: String)-> (name: String, age: Int, bdate: String)
    {
        get {
            return (self.name, self.age, self.bdate)
        }
        set(newVal) {
...
var per = PersonDetail(name: "Stuti", age: 23, bdate: "10/10")
print(per["Stuti"])
